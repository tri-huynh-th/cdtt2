<?php
// blogwebsite/register/dangky.php
...
$extraCss = "register/register.css"; // CSS riêng cho trang đăng ký
                ...
                if ($stmt->num_rows > 0) {
                    ...
                    if ($insert_stmt) {
                        ...
                        if ($insert_stmt->execute()) {
                            $successMessage = "Đăng ký tài khoản thành công! Bạn có thể <a href='" . BASE_PATH . "/auth/dangnhap.php'>đăng nhập</a> ngay bây giờ.";
